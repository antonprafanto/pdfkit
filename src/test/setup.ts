...
Object.defineProperty(window, 'electronAPI', {
  value: {
    ...
    getExternalDisplays: vi.fn().mockResolvedValue([]),
    getPresenterStatus: vi.fn().mockResolvedValue({
      active: false,
      displayId: null,
      sourceTabId: null,
    }),
    getPresenterBootstrapData: vi.fn().mockResolvedValue(null),
    startPresenterMode: vi.fn().mockResolvedValue({ success: true }),
    stopPresenterMode: vi.fn().mockResolvedValue(undefined),
    setPresenterPage: vi.fn().mockResolvedValue(undefined),
    onPresenterDisplaysChanged: vi.fn().mockReturnValue(() => {}),
    onPresenterStatusChanged: vi.fn().mockReturnValue(() => {}),
    onPresenterLoadDocument: vi.fn().mockReturnValue(() => {}),
    onPresenterPageChanged: vi.fn().mockReturnValue(() => {}),
    saveFileDialog: vi.fn().mockResolvedValue(null),
    savePdfFile: vi.fn().mockResolvedValue({ success: true }),
    selectDirectoryDialog: vi.fn().mockResolvedValue(null),
    openPath: vi.fn().mockResolvedValue({ success: true }),
    saveFileToDirectory: vi.fn().mockResolvedValue({ success: true }),
