    ...
    <div className="flex h-screen flex-col bg-gray-50 dark:bg-gray-900">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
        <button
          ...
          className="rounded-full p-4 text-white bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-110"
        ...
        <button
          ...
          className="rounded-full p-4 text-white bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 dark:from-pink-600 dark:to-purple-700 dark:hover:from-pink-700 dark:hover:to-purple-800 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-110"
        ...
        <button
          ...
          className="rounded-full p-4 text-gray-700 dark:text-gray-300 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-110"
